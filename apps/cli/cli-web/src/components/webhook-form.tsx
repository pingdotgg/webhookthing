              ...
              <div className="flex -space-x-px" key={item.id}>
                <div className="w-1/4 min-w-0 flex-1">
                  ...
                  <input
                    ...
                    className={classNames(
                      "relative block w-full min-w-0 flex-1 rounded-none border-gray-300 bg-transparent focus:z-10 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm",
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <input
                    ...
                    className="relative block w-auto min-w-0 flex-1 rounded-none border-gray-300 bg-transparent focus:z-10 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
